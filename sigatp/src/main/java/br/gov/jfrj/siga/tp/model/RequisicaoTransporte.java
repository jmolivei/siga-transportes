...
public class RequisicaoTransporte extends TpModel implements Comparable<RequisicaoTransporte>, ConvertableEntity {
    ...
    @SuppressWarnings("unchecked")
    public static List<RequisicaoTransporte> listarParaAgendamento(CpOrgaoUsuario cpOrgaoUsuario) {
        List<RequisicaoTransporte> requisicoes;

        StringBuilder qrl = new StringBuilder("SELECT req from RequisicaoTransporte req," + "Andamento an1 " + "WHERE req.id = an1.requisicaoTransporte.id " + "AND req.cpOrgaoUsuario.idOrgaoUsu = "
