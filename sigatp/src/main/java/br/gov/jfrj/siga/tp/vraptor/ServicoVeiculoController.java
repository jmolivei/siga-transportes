...
//	@RoleAdminFrota
	...
	public void listarFiltrado(EstadoServico estado) {
		if(estado == null) {
...
//	@RoleAdminFrota
	...
	private void gravarAndamentosRequisicao(EstadoRequisicao estadoRequisicao, DpPessoa dpPessoa,
...
//	@RoleAdminFrota
	...
	enum Template {LER, EDITAR, INCLUIR}
}