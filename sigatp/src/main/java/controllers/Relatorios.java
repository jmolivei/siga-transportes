...
public class Relatorios extends Controller {
    ...
    public static void listarAgendaPorVeiculo(@As(lang = { "*" }, value = { "dd/MM/yyyy" }) Calendar dataPesquisa, Long idVeiculo) throws ParseException {
    ...
    private static String gerarTimeLine(Calendar dataHoraPesquisa, String registros, List<Afastamento> afastamentos, List<Plantao> plantoes, List<Missao> missoes,
            List<ServicoVeiculo> servicosVeiculos, String entidade) {
        ...
        for (Afastamento afastamento : afastamentos) {
            ...
            if (afastamento.getDataHoraInicio().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR)
                    ...
                    && afastamento.getDataHoraInicio().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && afastamento.getDataHoraInicio().after(dataHoraPesquisa)) {
            ...
            if (afastamento.getDataHoraFim() != null) {
                if (afastamento.getDataHoraFim().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR) && afastamento.getDataHoraFim().get(Calendar.MONTH) == dataHoraPesquisa.get(Calendar.MONTH)
                        && afastamento.getDataHoraFim().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && afastamento.getDataHoraFim().after(dataHoraPesquisa)) {
        ...
        for (Plantao plantao : plantoes) {
            ...
            if (plantao.getDataHoraInicio().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR) && plantao.getDataHoraInicio().get(Calendar.MONTH) == dataHoraPesquisa.get(Calendar.MONTH)
                    && plantao.getDataHoraInicio().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && plantao.getDataHoraInicio().after(dataHoraPesquisa)) {
            ...
            if (plantao.getDataHoraFim() != null) {
                if (plantao.getDataHoraFim().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR) && plantao.getDataHoraFim().get(Calendar.MONTH) == dataHoraPesquisa.get(Calendar.MONTH)
                        && plantao.getDataHoraFim().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && plantao.getDataHoraFim().after(dataHoraPesquisa)) {
        ...
        for (ServicoVeiculo servicoVeiculo : servicosVeiculos) {
            ...
            if (servicoVeiculo.getDataHoraInicio().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR)
                    ...
                    && servicoVeiculo.getDataHoraInicio().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && servicoVeiculo.getDataHoraInicio().after(dataHoraPesquisa)) {
            ...
            if (servicoVeiculo.getDataHoraFim() != null) {
                if (servicoVeiculo.getDataHoraFim().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR)
                        ...
                        && servicoVeiculo.getDataHoraFim().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && servicoVeiculo.getDataHoraFim().after(dataHoraPesquisa)) {
        ...
        for (Missao missao : missoes) {
            ...
            if (missao.getDataHoraSaida().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR) && missao.getDataHoraSaida().get(Calendar.MONTH) == dataHoraPesquisa.get(Calendar.MONTH)
                    && missao.getDataHoraSaida().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && missao.getDataHoraSaida().after(dataHoraPesquisa)) {
            ...
            if (missao.getDataHoraRetorno() != null) {
                if (missao.getDataHoraRetorno().get(Calendar.YEAR) == dataHoraPesquisa.get(Calendar.YEAR) && missao.getDataHoraRetorno().get(Calendar.MONTH) == dataHoraPesquisa.get(Calendar.MONTH)
                        && missao.getDataHoraRetorno().get(Calendar.DAY_OF_MONTH) == dataHoraPesquisa.get(Calendar.DAY_OF_MONTH) && missao.getDataHoraRetorno().after(dataHoraPesquisa)) {
    ...
    public static void listarMissoesEmAndamento() {
        ...
        for (int i = 0; i < missoesFiltradas.size(); i++) {
            // registros += "[ \'" + missoes.get(i).getSequence() + " <a href=\"a.htm\">t</a>\'" + " , \'" + missoes.get(i).condutor.getNome() + "\', new Date(" +
