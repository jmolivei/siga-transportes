							...
							<tbody>
								<c:forEach items="${penalidades}" var="penalidade">
									<tr>
										...
										<td><a href="${linkTo[PenalidadeController].editar[penalidade.id]}">Editar</a></td>
										<td><a
											onclick="javascript:return confirm('Tem certeza de que deseja excluir os dados desta penalidade?');"
											href="${linkTo[PenalidadeController].excluir[penalidade.id]}">Excluir</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
