...
public class ModelsTest /* extends UnitTest */{
	...
	// static RequisicaoTransporte requisicaoTransporte1 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte2 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte3 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte4 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte5 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte6 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte7 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte8 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte9 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte10 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte11 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte12 = new
	// RequisicaoTransporte();
	// static RequisicaoTransporte requisicaoTransporte13 = new
	// RequisicaoTransporte();
	...
	// Assert.assertEquals(fornecedor1.logradouro,
	// fornecedor3.logradouro.toUpperCase());
	//
	// }
	//
	// @Test
	...
	// grupo1.finalidade =
	// "TRANSPORTE DOS PRESIDENTES, DOS VICE-PRESIDENTES E DOS CORREGEDORES DOS TRIBUNAIS REGIONAIS FEDERAIS";
	// grupo1.caracteristicas =
	// "VEÍCULOS DE MÉDIO PORTE, TIPO SEDAN, COR PRETA, COM CAPACIDADE DE TRANSPORTE DE ATÉ 5 (CINCO) PASSAGEIROS"
	// +
	...
	// grupo2.finalidade =
	// "TRANSPORTE, EM OBJETO DE SERVIÇO, DOS JUÍZES DE SEGUNDO GRAU E" +
	// " DOS JUÍZES DIRETORES DE FORO E DIRETORES DE SUBSEÇÕES JUDICIÁRIAS";
	// grupo2.caracteristicas =
	// "VEÍCULOS DE MÉDIO PORTE, TIPO SEDAN, COR PRETA, COM CAPACIDADE DE TRANSPORTE DE ATÉ 5 (CINCO) PASSAGEIROS"
	// +
	// ", MOTOR DE POTÊNCIA MÍNIMA" +
	// "DE 116 CV E MÁXIMA DE 159 CV (GASOLINA) E ITENS DE SEGURANÇA CONDIZENTES COM"
	...
	// grupo3.finalidade =
	// "TRANSPORTE, EM OBJETO DE SERVIÇO, DE JUÍZES DE PRIMEIRO GRAU E" +
	// " SERVIDORES NO DESEMPENHO DE ATIVIDADES EXTERNAS DE INTERESSE DA ADMINISTRAÇÃO";
	// grupo3.caracteristicas =
	// "VEÍCULOS DE PEQUENO PORTE, COM CAPACIDADE DE ATÉ 5 (CINCO)" +
	...
	//
	// grupo4.nome =
	// "VEÍCULO DE TRANSPORTE COLETIVO E DE APOIO ÀS ATIVIDADES JUDICIÁRIAS";
	// grupo4.finalidade =
	// "transporte, em objeto de serviço, de magistrados e servidores no" +
	...
	// grupo4.caracteristicas =
	// "pick-ups cabine dupla, vans com capacidade mínima de 12" +
	...
	// grupo5.finalidade =
	// "transporte de cargas leves no desempenho de atividades externas" +
	// " de interesse da administração".toUpperCase();
	// grupo5.caracteristicas =
	// "furgões, pick-ups de cabine simples, reboques e semireboques," +
	...
	// grupo6.caracteristicas =
	// "veículos tipo caminhão, motor de potência condizente com o serviço".toUpperCase();
	// grupo6.letra = "F";
	// grupo6.save();
	// grupo6.refresh();
	...
	// grupo7.finalidade =
	// "atendimento, em caráter de socorro médico ou de apoio às" +
	// "atividades de segurança, a magistrados e servidores".toUpperCase();
	// grupo7.caracteristicas =
	// "ambulâncias e veículos com dispositivo de alarme e luz" +
	...
	// veiculo2.refresh();
	//
	// List<DpLotacao> dpLotacoes = DpLotacao.find("orgaoUsuario",
	// cpOrgaoUsuario).fetch();
	...
	// lotacoesVeiculo3.dataHoraInicio = new GregorianCalendar(2011,
	// Calendar.OCTOBER, 11,
	// 8, 0);
	// lotacoesVeiculo3.dataHoraFim = new GregorianCalendar(2012,
	// Calendar.OCTOBER, 11,
	// 8, 0);
	// lotacoesVeiculo4 = new LotacaoVeiculo();
	// lotacoesVeiculo4.lotacao = dpLotacoes.get(1);
	// lotacoesVeiculo4.veiculo = veiculo2;
	// lotacoesVeiculo4.dataHoraInicio = new GregorianCalendar(2012,
	// Calendar.OCTOBER, 11,
	// 8, 1);
	...
	// lotacoesVeiculo1.dataHoraInicio = new GregorianCalendar(2011,
	// Calendar.OCTOBER, 11,
	// 8, 0);
	// lotacoesVeiculo1.dataHoraFim = new GregorianCalendar(2012,
	// Calendar.OCTOBER, 11,
	// 8, 0);
	// lotacoesVeiculo2 = new LotacaoVeiculo();
	// lotacoesVeiculo2.lotacao = dpLotacoes.get(1);
	// lotacoesVeiculo2.veiculo = veiculo1;
	// lotacoesVeiculo2.dataHoraInicio = new GregorianCalendar(2012,
	// Calendar.OCTOBER, 11,
	// 8, 1);
	...
	// List<DpPessoa> listaPossiveisCondutores =
	// Condutor.getPossiveisCondutores(cpOrgaoUsuario);
	//
	...
	// autoDeInfracao1.dataHora = new GregorianCalendar(2011, Calendar.OCTOBER,
	// 11, 8, 0);
	...
	// autoDeInfracao1.dataDeVencimento = new GregorianCalendar(2011,
	// Calendar.OCTOBER, 12, 8, 0);
	// autoDeInfracao1.dataDePagamento = new GregorianCalendar(2011,
	// Calendar.OCTOBER, 12, 8, 0);
	...
	// afastamento1.dataHoraInicio = new GregorianCalendar(2012,
	// Calendar.OCTOBER, 11, 8, 1);
	// afastamento1.dataHoraFim = new GregorianCalendar(2012, Calendar.OCTOBER,
	// 11, 8, 0);
	// afastamento1.save();
	...
	// plantao1.dataHoraInicio = new GregorianCalendar(2012, Calendar.OCTOBER,
	// 11, 8, 1);
	// plantao1.dataHoraFim = new GregorianCalendar(2012, Calendar.OCTOBER, 11,
	// 8, 0);
	// plantao1.save();
	// plantao1.refresh();
	...
	// requisicaoTransporte1.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 11, 8, 1);
	// requisicaoTransporte1.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 11, 13, 10);
	// requisicaoTransporte1.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 11, 15, 10);
	// requisicaoTransporte1.finalidade = "CURSO EXTERNO";
	// requisicaoTransporte1.itinerarios =
	// "RUA DO ACRE - AV.ALMEIRANTE BARROSO";
	...
	// requisicaoTransporte2.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 8, 1);
	// requisicaoTransporte2.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 13, 10);
	// requisicaoTransporte2.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 12, 15, 10);
	// requisicaoTransporte2.finalidade = "CONGRESSO EM BRASILIA";
	// requisicaoTransporte2.itinerarios =
	// "RUA DO ACRE - AEROPORTO SANTOS DUMONT";
	...
	// requisicaoTransporte3.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 8, 1);
	// requisicaoTransporte3.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 13, 10);
	// requisicaoTransporte3.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 12, 15, 10);
	...
	// requisicaoTransporte7.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 11, 8, 1);
	// requisicaoTransporte7.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 13, 10);
	// requisicaoTransporte7.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 12, 15, 10);
	...
	// requisicaoTransporte8.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 8, 1);
	// requisicaoTransporte8.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 13, 10);
	// requisicaoTransporte8.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 12, 15, 10);
	// requisicaoTransporte8.finalidade = "VOLTA PARA CASA";
	// requisicaoTransporte8.itinerarios =
	// "RUA DO ACRE - RUA VOLUNTARIOS DA PATRIA";
	...
	// requisicaoTransporte9.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 8, 1);
	// requisicaoTransporte9.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 13, 10);
	// requisicaoTransporte9.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 12, 15, 10);
	...
	// requisicaoTransporte4.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 11, 8, 1);
	// requisicaoTransporte4.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 11, 13, 10);
	// requisicaoTransporte4.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 11, 15, 10);
	...
	// requisicaoTransporte5.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 8, 1);
	// requisicaoTransporte5.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 11, 13, 10);
	// requisicaoTransporte5.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 11, 15, 10);
	...
	// requisicaoTransporte6.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 8, 1);
	// requisicaoTransporte6.dataHoraSaidaPrevista = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 13, 10);
	// requisicaoTransporte6.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 12, 15, 10);
	// requisicaoTransporte6.finalidade = "CONGRESSO EM FORTALEZA";
	// requisicaoTransporte6.itinerarios =
	// "AV.ALMEIRANTE BARROSO - AEROPORTO GALEAO";
	...
	// requisicaoTransporte11.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 12, 8, 1);
	// requisicaoTransporte11.dataHoraSaidaPrevista = new
	// GregorianCalendar(2014, Calendar.JANUARY, 13, 13, 10);
	// requisicaoTransporte11.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 13, 15, 10);
	...
	// requisicaoTransporte12.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 13, 8, 1);
	// requisicaoTransporte12.dataHoraSaidaPrevista = new
	// GregorianCalendar(2014, Calendar.JANUARY, 13, 16, 10);
	// requisicaoTransporte12.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 13, 17, 10);
	// requisicaoTransporte12.finalidade = "VOLTA PARA CASA";
	// requisicaoTransporte12.itinerarios =
	// "RUA DO ACRE - RUA VOLUNTARIOS DA PATRIA";
	...
	// requisicaoTransporte13.dataHora = new GregorianCalendar(2014,
	// Calendar.JANUARY, 13, 8, 1);
	// requisicaoTransporte13.dataHoraSaidaPrevista = new
	// GregorianCalendar(2014, Calendar.JANUARY, 13, 17, 30);
	// requisicaoTransporte13.dataHoraRetornoPrevisto = new
	// GregorianCalendar(2014, Calendar.JANUARY, 13, 18, 30);
	...
	// requisicaoTransporte1 =
	// RequisicaoTransporte.findById(requisicaoTransporte1.id);
	// requisicaoTransporte1.save();
	// requisicaoTransporte1.refresh();
	//
	...
	//
	//
	// requisicaoTransporte2 =
	// RequisicaoTransporte.findById(requisicaoTransporte2.id);
	// requisicaoTransporte2.save();
	// requisicaoTransporte2.refresh();
	//
	...
	// andamento2.save();
	//
	// requisicaoTransporte3 =
	// RequisicaoTransporte.findById(requisicaoTransporte3.id);
	// requisicaoTransporte3.save();
	// requisicaoTransporte3.refresh();
	//
	...
	// requisicaoTransporte7 =
	// RequisicaoTransporte.findById(requisicaoTransporte7.id);
	// requisicaoTransporte7.save();
	// requisicaoTransporte7.refresh();
	//
	...
	// andamento7.save();
	//
	// requisicaoTransporte8 =
	// RequisicaoTransporte.findById(requisicaoTransporte8.id);
	// requisicaoTransporte8.save();
	// requisicaoTransporte8.refresh();
	//
	...
	// andamento8.save();
	//
	// requisicaoTransporte9 =
	// RequisicaoTransporte.findById(requisicaoTransporte9.id);
	// requisicaoTransporte9.save();
	// requisicaoTransporte9.refresh();
	//
	...
	// missao1.dataHora = new GregorianCalendar(2014, Calendar.JANUARY, 31, 8,
	// 1);
	// missao1.dataHoraSaida = new GregorianCalendar(2014, Calendar.JANUARY, 31,
	// 8, 1);
	// missao1.dataHoraRetorno = new GregorianCalendar(2014, Calendar.JANUARY,
	// 31, 10, 17);
	...
	// missao2.dataHora = new GregorianCalendar(2014, Calendar.JANUARY, 31, 15,
	// 1);
	// missao2.dataHoraSaida = new GregorianCalendar(2014, Calendar.JANUARY, 31,
	// 17, 1);;
	...
	// missao3.dataHora = new GregorianCalendar(2014, Calendar.JANUARY, 30, 15,
	// 1);
	// missao3.dataHoraSaida = new GregorianCalendar(2014, Calendar.JANUARY, 30,
	// 17, 1);;
