...
//		
//		boolean resultadoTestes = getPagina().contemTextos(_TEXTO_INICIO_PAGINA_LISTAR_TODAS_PARA_APROVACAO, _TEXTO_MEIO_PAGINA_LISTAR_TODAS_PARA_APROVACAO, _TEXTO_FIM_PAGINA_LISTAR_TODAS_PARA_APROVACAO);
//		
//		getLogin().acessarMenuAbertasListarRequisicoesParaAprovacao();
//		
//		resultadoTestes = resultadoTestes && getPagina().contemTextos(_TEXTO_INICIO_PAGINA_INICIAL_LISTAR_ABERTAS_PARA_APROVACAO, _TEXTO_MEIO_PAGINA_INICIAL_LISTAR_ABERTAS_PARA_APROVACAO, _TEXTO_FIM_PAGINA_INICIAL_LISTAR_ABERTAS_PARA_APROVACAO);
//		
//		Assert.assertTrue(resultadoTestes);
//	}
//	
